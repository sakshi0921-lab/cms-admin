...
// Define the type for your row model
interface RowModel {
  id: number;
  trn: string;
  school: string;
...
const Application = () => {
  ...
  // Update the type of newRow to match the structure of your row model
  ...
  const handleEditRow = (id: number) => {
    ...
    if (rowToEdit) {
      // Type assertion to ensure the row matches the expected structure
      setNewRow({
        trn: rowToEdit.trn,
  ...
  return (
    <Layout>
      <Box sx={{ padding: 1, backgroundColor: "#2a2b2b", color: "#22dfe6" }}>
